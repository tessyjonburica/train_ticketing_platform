...
const scheduleValidator = [
    body('name').notEmpty( {msg: "Name is required"} ).isAlpha().withMessage("Only alphabets are allowed").isLength({max: 255}).withMessage('Name cannot be more than 255 characters'),
    ...
    body('departureStation') .notEmpty().withMessage("Departure station is required").isAlpha( { msg : 'Only alphabets are allowed'} ).isLength({max: 255}).withMessage("Departure station cannot be more than 255 characters"),
]
